          ...
          ${orders.map((o, idx) => `
            <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.05);">
              ...
              <td style="padding: 12px 10px; text-align: center;">
                <a href="https://wa.me/${(o.phone || '').replace(/[^0-9]/g, '').length === 10 ? '91' + (o.phone || '').replace(/[^0-9]/g, '') : ((o.phone || '').replace(/[^0-9]/g, '') || '917027340360')}?text=${encodeURIComponent(`*Namaste ${o.clientName || ''} ji!*\n\nVyapar Digital se sampark karne ke liye dhanyawad. Aapke business *"${o.businessName || ''}"* ka project brief hamein mil gaya hai.\n\n📌 *Official Project Tracking ID:* ${o.trackingId}\n🛠️ *Service:* ${o.packageName}\n💰 *Package Rate:* ₹${(o.estimatedPrice || 0).toLocaleString('en-IN')}\n\nAap website par is Tracking ID se real-time status dekh sakte hain: https://vyapardigital.vercel.app/#tracker\n\nKripya aage shuru karne ke liye confirm karein.`)}" target="_blank" class="btn btn-whatsapp btn-sm" title="Send Official Tracking ID to Client on WhatsApp">
