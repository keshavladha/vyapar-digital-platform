// Vyapar Digital - Personal Chatbot (Saarthi)
...
function renderChatbotContainer() {
  ...
  container.innerHTML = `
    ...
    <div id="chatbot-trigger-btn" class="chatbot-trigger-btn" title="Saarthi - Digital Guide">
      ...
      <span class="chatbot-badge-text" id="chatbot-trigger-text">Saarthi</span>
    </div>
    ...
    <div id="chatbot-window" class="chatbot-window">
      ...
      <form class="chatbot-input-area" id="chatbot-form">
        <input 
          ...
          placeholder="${currentLang === 'hi' ? 'Saarthi से पूछें या ट्रैकिंग ID लिखें...' : 'Ask Saarthi or enter tracking ID...'}" 
          autocomplete="off"
        >
